...
<div class="dialog" >
	  <form name="postform" method="post" action="?menu=login">
...
if(isset($_POST['username'])){
	...
	if(empty($username) || empty($password)){
		...
		if($cek){
			...
			?><script language="javascript">alert('Login Berhasil, Selamat Datang <?php echo $username ?>');document.location.href='index.php'</script><?php
		}else{
